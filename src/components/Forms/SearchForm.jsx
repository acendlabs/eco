...
const SearchForm = () => {
  ...
  return (
    <div
      className={`w-full md:w-3/5 flex it items-center rounded-lg font-normal border-[3px] border-acend-theme-dark bg-transparent py-2 px-4 md:px-14 outline-none text-sm md:text-base`}
    >
      <input
        // value={user.username}
