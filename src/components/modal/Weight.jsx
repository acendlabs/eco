    ...
    <div className="w-[80%] sm:w-80 absolute z-10 top-[10%] left-2/4 -translate-x-2/4">
      <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div className="py-16 px-6 lg:px-8">
          ...
          <form className="space-y-4 py-4" action="#">
            <div>
              <input
                // value={user.username}
                className={` border-[#0F2F1D] w-full rounded-lg font-normal border-[3px]  bg-transparent py-3.5 px-8 text-base outline-none`}
                type="text"
                name="username"
